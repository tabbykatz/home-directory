...
This is a personal assistant directory focused on workflows arounf logging daily software engineering work, tracking performance metrics, integrating feedback from mentorship, and creating documentation for all of the same.
...
1. **Always check yesterday's tomorrow_reminders first**
2. **Ask which reminders were completed today**
3. **Carry forward uncompleted reminders to today's tomorrow_reminders**
4. **Add any new reminders for tomorrow**
5. **Never assume or guess reminder status - always ask**
